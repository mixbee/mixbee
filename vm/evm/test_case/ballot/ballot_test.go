...
import (
	"testing"
	"github.com/mixbee/mixbee/vm/evm/test_case"
	"fmt"
	"math/big"
...
func TestGetSigner(t *testing.T) {
	...
	account1, _ := account.NewAccount()
	account2, _ := account.NewAccount()
	account3, _ := account.NewAccount()
	account4, _ := account.NewAccount()
