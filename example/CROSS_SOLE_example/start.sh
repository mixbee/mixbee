...
### 主链验证节点抵押押金
sleep 10
docker exec node1.example.com mixbee cross cdeposit --from ANZ7Yh26agCtQjQYAZHZqpXL3jQVPCigxo --amount 20000 --cpbk 02e750714ff8dfa402a9b7cce6db90de8a72b7e1efe0836e0f65f92b97924e9c7e --password test
...
docker exec node1.example.com mixbee cross ctransfer --from ANZ7Yh26agCtQjQYAZHZqpXL3jQVPCigxo --to Ac6Ac6w3XdhrZWSMvzFyf6WSAtUbBHiFmR --aamount 1000 --bamount 10000 --achainid 4 --bchainid 5 --nonce 0 --cpbk 02e750714ff8dfa402a9b7cce6db90de8a72b7e1efe0836e0f65f92b97924e9c7e --password test

echo "sub chain addr(Ac6Ac6w3XdhrZWSMvzFyf6WSAtUbBHiFmR) cross chain transfer"
docker exec node2.example.com mixbee cross ctransfer --from Ac6Ac6w3XdhrZWSMvzFyf6WSAtUbBHiFmR --to ANZ7Yh26agCtQjQYAZHZqpXL3jQVPCigxo --aamount 10000 --bamount 1000 --achainid 5 --bchainid 4 --nonce 0 --cpbk 02e750714ff8dfa402a9b7cce6db90de8a72b7e1efe0836e0f65f92b97924e9c7e --password test
